          ...
          <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
            ...
            >
              ...
              <div>
                ...
                <div className="text-[10px] font-semibold text-amber-600 tracking-widest uppercase leading-none mt-0.5">Vendor Panel</div>
              </div>
            </button>
            <button
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between bg-white border-b px-4 sm:px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block text-xs text-amber-600 font-semibold bg-amber-50 px-2.5 py-1 rounded-lg">
              Vendor
            </div>
