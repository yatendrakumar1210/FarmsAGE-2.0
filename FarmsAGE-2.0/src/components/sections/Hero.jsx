...
const Hero = () => {
  ...
  return (
    <section className="relative bg-white pt-4 sm:pt-6 md:pt-8 pb-8 sm:pb-10 md:pb-12 overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative group cursor-pointer overflow-hidden rounded-[2rem] lg:rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-50">
          <div className="relative min-h-[320px] sm:min-h-[380px] md:min-h-[450px] lg:min-h-[520px] xl:min-h-[600px] w-full overflow-hidden">
            {" "}
            <motion.img
              initial={{ scale: 1.1 }}
              animate={{ scale: 1 }}
          ...
          {/* Bottom Trust Strip */}
          <div className="absolute bottom-0 left-0 right-0 bg-white/5 backdrop-blur-md border-t border-white/10 hidden md:flex flex-wrap items-center justify-between lg:justify-around gap-4 px-4 py-4 sm:py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-8 sm:mt-10 md:mt-12 px-0 sm:px-2 lg:px-0">
          <motion.div
          ...
          >
            ...
            <div className="absolute inset-0 p-6 sm:p-10 flex flex-col justify-center">
              ...
              <p className="text-emerald-50 text-sm font-medium mt-2">
                On fresh seasonal vegetables today.
              </p>
            </div>
          </motion.div>
