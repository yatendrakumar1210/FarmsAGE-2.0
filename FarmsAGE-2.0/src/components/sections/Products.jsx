...
const Products = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-12 font-sans overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-hide">
          <div className="flex bg-slate-50 p-1.5 rounded-2xl border border-slate-100">
            {filterOptions.map((filter) => (
              <button
                ...
                className={`px-6 py-2 rounded-[1rem] text-sm font-bold transition-all duration-300 ${
                  activeFilter === filter
          ...
          <button className="p-3.5 bg-slate-900 text-white rounded-2xl hover:bg-black transition-all shadow-lg shadow-slate-200">
            <Filter size={18} />
          </button>
        </div>
      </div>
      ...
      <div className="mt-16 text-center">
        <button 
          ...
          className="group inline-flex items-center gap-4 bg-white border border-slate-200 px-12 py-4.5 rounded-[1.5rem] font-bold text-slate-800 hover:border-emerald-500 hover:text-emerald-600 transition-all shadow-sm hover:shadow-xl hover:shadow-emerald-50/40"
        >
